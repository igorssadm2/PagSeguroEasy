...
{
    internal static class PagSeguroUtils
    {
        /// <summary>
        ...
        {
            return PagSeguroUtils.TruncateValue(PagSeguroUtils.RemoveExtraSpaces(value), limit, endChars);
        }
        ...
        {
            return string.IsNullOrEmpty(PagSeguroUtils.RemoveExtraSpaces(value));
        }
