...
namespace PagSeguroEasy.Library.Helps
{
    internal static class StringHelps
    {
        ...
        {
            return StringHelps.TruncateValue(StringHelps.RemoveExtraSpaces(value), limit, endChars);
        }
        ...
        {
            return string.IsNullOrEmpty(StringHelps.RemoveExtraSpaces(value));
        }
